...
class CommentCommandServiceTest {
    ...
    inner class PostReply {
        ...
        fun savesReply() {
            ...
            val post = Post.builder()
                ...
                .content("content")
                .build()
            ReflectionTestUtils.setField(post, "author", member)

            val now = java.time.LocalDateTime.now(fixedClock)
            val parent = Comment.builder()
                .id(5L)
                .content("parent")
                .build()
            ReflectionTestUtils.setField(parent, "post", post)
            ReflectionTestUtils.setField(parent, "author", member)
            ReflectionTestUtils.setField(parent, "createdAt", now)
            ReflectionTestUtils.setField(parent, "updatedAt", now)
    ...
    inner class EditComment {
        ...
        fun editsComment() {
            ...
            ReflectionTestUtils.setField(comment, "author", member)
