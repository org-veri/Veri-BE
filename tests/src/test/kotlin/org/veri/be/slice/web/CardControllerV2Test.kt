...
class CardControllerV2Test : ControllerTestSupport() {
    ...
    inner class UploadCardImageV2 {
        ...
        @Test
        @DisplayName("요청하면 → presigned post form을 반환한다")
        fun returnsPresignedPostForm() {
            ...
            post("/api/v2/cards/image")
                .andExpect(status().isOk)

            then(cardCommandService).should().getPresignedPost()
        }
    }
}
