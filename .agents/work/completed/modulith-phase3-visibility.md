...
- [x] **Demote visibility** for internal types that are only used inside their module.
- [x] **Adjust package layouts** if required to keep access within module boundaries.

## Phase 3: Verification
- [x] **Run Modulith verification** after visibility changes.
...
- **2025-12-30**: **Phase 1 inventory completed**. Package boundaries prevent package-private demotion without reorganizing `storage` vs `core` packages; task moved **On Hold** pending decision.
 - **2025-12-30**: **Completed**. Visibility enforcement implemented after storage integration and package realignment.
   - **Reference**:
     ```
