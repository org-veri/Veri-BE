...
## Phase 1: Inventory
- [ ] **List repositories/services/DTOs** per module that are candidates for package-private visibility.
- [ ] **Trace usage** across modules to avoid breaking dependencies.
