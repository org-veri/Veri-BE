package org.goorm.veri.veribe.global.auth.aop;
...
import org.goorm.veri.veribe.global.auth.annotations.UseGuards;
import org.goorm.veri.veribe.global.auth.guards.Guard;
import org.goorm.veri.veribe.global.auth.utils.MemberExtractor;
...
public class UseGuardsAspect {
    ...
    @Pointcut(
            "@annotation(org.goorm.veri.veribe.global.auth.annotations.UseGuards) || " +
                    "@within(org.goorm.veri.veribe.global.auth.annotations.UseGuards)"
    )
